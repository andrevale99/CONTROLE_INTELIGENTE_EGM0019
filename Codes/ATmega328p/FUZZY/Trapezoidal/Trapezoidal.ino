...
void loop()
{
  ...
  {                                                                          // SE já se passou pelo menos um "período"
...
{ // Função que comanda a Ponte H, p/ acionar o Motor
  if (controle >= 0)
  {                                // SE o controle for maior ou igual a 0
