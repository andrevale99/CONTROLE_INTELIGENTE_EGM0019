...
{
    PORTx_LCD = (cmd >> 4); /* sending upper nibble */
    ...
    PORTx_LCD = (cmd & 0x0F); /* sending lower nibble */
    pulseEN()
...
void init_4bitsLCD()
{
    ...
    LCD_cmd(DISPLAY_ON | CURSOR_ON | BLINK_CURSOR, CMD); // mensagem aparente cursor inativo não piscando
